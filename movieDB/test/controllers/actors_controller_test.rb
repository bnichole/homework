...
class ActorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actor" do
    assert_difference('Actor.count') do
      post actors_url, params: { actor: { genre_id: @actor.genre_id, movie_id: @actor.movie_id, name: @actor.name } }
    end
  ...
  test "should update actor" do
    patch actor_url(@actor), params: { actor: { genre_id: @actor.genre_id, movie_id: @actor.movie_id, name: @actor.name } }
