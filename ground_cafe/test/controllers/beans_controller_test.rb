...
class BeansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bean" do
    assert_difference('Bean.count') do
      post beans_url, params: { bean: { blend: @bean.blend, brew: @bean.brew, cost: @bean.cost, flavor: @bean.flavor, image: @bean.image, size: @bean.size } }
    end
  ...
  test "should update bean" do
    patch bean_url(@bean), params: { bean: { blend: @bean.blend, brew: @bean.brew, cost: @bean.cost, flavor: @bean.flavor, image: @bean.image, size: @bean.size } }
